...
def main():
	...
	i = 0
	#for i in range (y):
	fn = 'output_'+"en-US_AllisonVoicefordict"+'.wav'
	with open(join(dirname(__file__), "/home/arvind/Desktop/project/v2/ebook/audio/"+fn), 'wb') as audio_file:
